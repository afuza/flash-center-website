...
$mail->setFrom('activation@flashing.center', 'Flashing Center');
$mail->addAddress($_POST['email'], $_POST['nama']);
$mail->isHTML(true);
$mail->Subject = "Aktivasi Akun Flashing Center";
$mail->Body = "<html lang='en'>
  ...
  <body class='o_body o_bg-light' style='width: 100%;margin: 0px;padding: 0px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #dbe5ea;'>
    ...
    <table width='100%' cellspacing='0' cellpadding='0' border='0' role='presentation'>
      <tbody>
        <tr>
          <td class='o_hide' align='center' style='display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;'>Email Actiovation For singup Flashing Center</td>
        </tr>
      </tbody>
    </table>
    <!-- header -->
              ...
              <tbody>
                <tr>
                  <td class='o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ebf5fa;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 9px;padding-bottom: 20px;'>
                    ...
                    <p style='margin-top: 0px;margin-bottom: 0px;'>Klik Verify Untuk Mengaktifkan Akun kamu</p>
                  </td>
                </tr>
              </tbody>
            </table>
                      ...
                      <tbody>
                        <tr>
                          <td width='300' class='o_btn o_bg-primary o_br o_heading o_text' align='center' style='font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #126de5;border-radius: 4px;'>
                            ...
                            <a class='o_text-white' href='http://hpanel.flashing.center/info/approve_activation.php?t=".$token."' style='text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;'>Verify My E-mail Address</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <tbody>
                <tr>
                  <td class='o_bg-white o_px-md o_py o_sans o_text o_text-secondary' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 8px;padding-bottom: -12px;'>
                    ...
                    <p style='margin-top: 0px;margin-bottom: 0px;'>Saya harap bagi pelanggan baru yang ingin mendaftar, untuk membaca kembali <b>Syarat Dan Ketentuan</b> yang berlaku. segala kecurangan yang di lakukan oleh pengguna akan kami serahkan kepada badan hukum yang berwenang.</p>
                  </td>
                </tr>
              </tbody>
            </table>
