<?php
          ...
          include "sender-mail.php";
          //Recipients

          $mail->setFrom("no-reply@flashing.center", "Flashing Center"); //email pengirim

          $mail->addAddress($emailTo); // Email penerima

          $mail->addReplyTo("no-reply@flashing.center");

          //Content href='$url'

          $url = "http://" . $_SERVER["HTTP_HOST"] ."/auth/reset-password/reset.php?reset_pass=$end"; //sesuaikan berdasarkan link server dan nama file
  ...
  <body class='o_body o_bg-light' style='width: 100%;margin: 0px;padding: 0px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #dbe5ea;'>
    ...
    <table width='100%' cellspacing='0' cellpadding='0' border='0' role='presentation'>
      <tbody>
        <tr>
          <td class='o_hide' align='center' style='display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;'>Email Reset Password</td>
        </tr>
      </tbody>
    </table>
    <!-- header -->
              ...
              <tbody>
                <tr>
                  <td class='o_bg-dark o_px o_py-md o_br-t o_sans o_text' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #242b3d;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 20px;padding-bottom: 20px;'>
                    ...
                    <p style='margin-top: 0px;margin-bottom: 0px;'><a class='o_text-white' href='https://flashing.center' style='text-decoration: none;outline: none;color: #ffffff;'><img src='https://flashingcenter.b-cdn.net/assets/images/logo/Flashing-center_logo.png' width='500' height='210' alt='flashingcenter' style='max-width: 136px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;'></a></p>
        ...
        <tr>
          <td class='o_bg-light o_px-xs' align='center' style='background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;'>
            ...
            <table class='o_block' width='100%' cellspacing='0' cellpadding='0' border='0' role='presentation' style='max-width: 632px;margin: 0 auto;'>
              <tbody>
                <tr>
                  <td class='o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ebf5fa;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 9px;padding-bottom: 20px;'>
                    <table role='presentation' cellspacing='0' cellpadding='0' border='0'>
                      <tbody>
                        <tr>
                          <td class='o_bb-primary' height='40' width='32' style='border-bottom: 1px solid #126de5;'>&nbsp; </td>
                          <td rowspan='2' class='o_sans o_text o_text-secondary o_px o_py' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 8px;'>
                          
                            <img src='https://flashingcenter.b-cdn.net/assets/images/email-48-primary.png' width='48' height='48' alt='' style='max-width: 48px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;'>
                    ...
                    <h2 class='o_heading o_text-dark o_mb-xxs' style='font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;'>Update Password</h2>
                    
                    <p style='margin-top: 0px;margin-bottom: 0px;'>Klik Tombol untuk ke halaman Reset Password</p>
                  </td>
                </tr>
              </tbody>
            </table>
                      ...
                      <tbody>
                        <tr>
                          <td width='284' class='o_bg-ultra_light o_br o_text-xs o_sans o_px-xs o_py' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;border-radius: 4px;padding-left: 8px;padding-right: 8px;padding-top: 16px;padding-bottom: 16px;'>
                            <p class='o_text-dark' style='color: #242b3d;margin-top: 0px;margin-bottom: 0px;'><strong> ".$emailTo." </strong></p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
        ...
        <tr>
          <td class='o_bg-light o_px-xs' align='center' style='background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;'>
            ...
            <table class='o_block' width='100%' cellspacing='0' cellpadding='0' border='0' role='presentation' style='max-width: 632px;margin: 0 auto;'>
              <tbody>
                <tr>
                  <td class='o_bg-white o_px-md o_py o_sans o_text o_text-secondary' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 8px;padding-bottom: -12px;'>
                  
                    <p style='margin-top: 0px;margin-bottom: 0px;'>Pengubahan password dapat di lakukan kapan saja jika merasa tidak melakukan tindakan ini segera melapor ke pada kami ke email <b>admin@flashing.center</b>.</p>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <tr>
          <td class='o_bg-light o_px-xs o_pb-lg o_xs-pb-xs' align='center' style='background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;padding-bottom: 32px;'>
            ...
            <table class='o_block' width='100%' cellspacing='0' cellpadding='0' border='0' role='presentation' style='max-width: 632px;margin: 0 auto;'>
              <tbody>
                <tr>
                  <td class='o_bg-white o_px-md o_py-lg o_bt-light o_br-b o_sans o_text-xs o_text-light' align='center' style='font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;border-top: 1px solid #d3dce0;border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px;padding-top: 10px;padding-bottom: 8px;'>
                  
                  
                    <p class='o_mb' style='margin-top: 0px;margin-bottom: 16px;'><a class='o_text-primary' href='https://flashing.center/' style='text-decoration: none;outline: none;color: #126de5;'>
                    
                    
                    <img src='https://flashingcenter.b-cdn.net/assets/images/logo/Flashing-center_symbol.ico' width='36' height='36' alt='flashinglogo' style='max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;'></a></p>
                    <p class='o_mb' style='margin-top: 0px;margin-bottom: 16px;'>©2020 Flashing - Center</p>
