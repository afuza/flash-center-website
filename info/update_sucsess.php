<html lang="en">
    <head>
         <meta charset="utf-8" />
        <title>Update success| Flashing - Center</title>
                          ...
                          <div class="card-header pt-4 pb-4 text-center bg-dark">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center m-auto">
                                  <img src="https://flashingcenter.b-cdn.net/assets/images/pngwing.com%20(1).png" alt="mail sent image" height="64" />
                                   <h4 class="text-dark-50 text-center mt-4 font-weight-bold">Update Password success</h4>
                                    <p class="text-muted mb-4">
                                      Selamat password kamu sudah di ganti login Kemabli dan nikmati jasa kami.
                                    </p>
                                    </div>
